...
from donation.infra import rabbitmq_config_from_env
from donation.infra.di.event_consumer import (
    event_consumer_ioc_container_factory,
)
from donation.presentation.event_consumer import create_broker
